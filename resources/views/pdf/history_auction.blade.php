...
<head>
    ...
    <title>Data History Lelang {{ $auction->item->item_name }}</title>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="tengah">
                    ...
                    <b>Jl. Veteran No.45, RT.01/RW.05, Panaragan, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16125</b>
                </td>
            </tr>
        </table>
        <hr>
        <h4 class="text-center">Data History Lelang {{ $auction->item->item_name }}</h4>
